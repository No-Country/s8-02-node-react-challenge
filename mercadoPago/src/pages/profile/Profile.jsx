        ...
        <>
            ...
            <div className='h-28 flex items-center gap-4 bg-colorButton shadow-insetShadow pl-4 pr-[23px]'>
                ...
                <div className=' text-white'>
                    ...
                    <span className='font-medium text-sm leading-[17.07px]'>{email}</span>
                </div>
            </div>

            <div className={`${isView ? 'rounded-[10px]' : 'rounded-t-[10px]'} bg-[#AACCFF] h-10 flex items-center justify-between pl-4 pr-6 mt-6 ml-4 mr-4 cursor-pointer`} onClick={() => setIsView(!isView)}>
                <p className='font-semibold text-base'>CVU y Alias</p>
                {
                    isView ?
                        <svg className='mr-[22.43px]' width='7' height='12' viewBox='0 0 7 12' fill='none' xmlns='http://www.w3.org/2000/svg'>
            ...
            <div style={{display: `${isView ? 'none' : 'flex'}`}} className='flex-col bg-[#AACCFF] h-[120px] ml-4 mr-4 rounded-b-[10px] pl-4 pr-6'>
                ...
                <div className='pt-3'>
                    <h2 className='font-semibold text-sm text-colorButton leading-[17.07px]'>Alias</h2>
                    <div className='flex'>
                        <p className='pr-2 font-semibold leading-[19.5px]'>{alias}</p>
                        <button className='bg-transparent border-none p-0' onClick={() => copy(alias)}>
                            <svg width='17' height='20' viewBox='0 0 17 20' fill='none' xmlns='http://www.w3.org/2000/svg'>
                                <path d='M2 20C1.45 20 0.979167 19.8042 0.5875 19.4125C0.195833 19.0208 0 18.55 0 18V5C0 4.71667 0.0958333 4.47917 0.2875 4.2875C0.479167 4.09583 0.716667 4 1 4C1.28333 4 1.52083 4.09583 1.7125 4.2875C1.90417 4.47917 2 4.71667 2 5V18H12C12.2833 18 12.5208 18.0958 12.7125 18.2875C12.9042 18.4792 13 18.7167 13 19C13 19.2833 12.9042 19.5208 12.7125 19.7125C12.5208 19.9042 12.2833 20 12 20H2ZM6 16C5.45 16 4.97917 15.8042 4.5875 15.4125C4.19583 15.0208 4 14.55 4 14V2C4 1.45 4.19583 0.979167 4.5875 0.5875C4.97917 0.195833 5.45 0 6 0H15C15.55 0 16.0208 0.195833 16.4125 0.5875C16.8042 0.979167 17 1.45 17 2V14C17 14.55 16.8042 15.0208 16.4125 15.4125C16.0208 15.8042 15.55 16 15 16H6ZM6 14H15V2H6V14Z' fill='#10224D' />
                            </svg>
                        </button>
